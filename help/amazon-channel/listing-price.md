...
1. Expanda el _[!UICONTROL Listing Price]_sección.
...
| [!UICONTROL Apply Value Added Tax (VAT)] | Los vendedores de la Unión Europea utilizan el IVA.<br><br>Elegir `Disabled` si no quieres que el IVA se añada a los precios del anuncio.<br><br>Elegir `Enabled` y, a continuación, introduzca el porcentaje de IVA para aplicar el IVA a los precios del anuncio. |
