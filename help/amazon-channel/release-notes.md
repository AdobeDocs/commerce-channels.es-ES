...
![Se ha corregido un problema](../assets/fix.svg) Se ha reducido el ruido en los registros.

![Se ha corregido un problema](../assets/fix.svg) Se ha mejorado la estabilidad de la extracción de actualizaciones.

![Se ha corregido un problema](../assets/fix.svg) Se ha simplificado el proceso para ejecutar una sola acción como extracción o para aplicar desde CLI.

![Se ha corregido un problema](../assets/fix.svg) Se ha actualizado la dependencia de `magento/services-connector`.

![Se ha corregido un problema](../assets/fix.svg) Se han corregido problemas de sincronización en cuentas de Reino Unido con código de país no válido.

![Se ha corregido un problema](../assets/fix.svg) El código incrustado entity_type_id para la entidad de producto del catálogo causa problemas con la fuente de precios del Magento.

![Se ha corregido un problema](../assets/fix.svg) Se ha corregido un problema que impedía que las cuentas eliminadas en un servidor de otra instancia de la interfaz de usuario también se eliminaran de la misma.

![Se ha corregido un problema](../assets/fix.svg) Se ha corregido un problema con algunas reglas de carro de compras que dañaban la importación de pedidos.
...
![Corrección](../assets/fix.svg) Se ha añadido compatibilidad con Adobe Commerce 2.4.4.
...
Si tiene un [!DNL Amazon sales channel] instalado e intente actualizar el Adobe Commerce a la versión 2.4.0., se le pedirá que actualice la extensión antes de completar la actualización de Adobe Commerce.
