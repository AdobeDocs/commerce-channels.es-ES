...
1. Elija la [!DNL Commerce] [ámbito](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html#scope-settings) para el atributo y, a continuación, seleccione una o varias vistas de tienda en las que importar los valores de Amazon.
...
| [!UICONTROL Magento Product Attribute Scope] | Indica el [ámbito](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html#scope-settings) para el atributo. Opciones: Global/Vista de tienda<br>Cuando se establece en `Global`Sin embargo, la vista de la tienda no se puede editar una vez creado el atributo. |
| [!UICONTROL Store Views (to import values into to)] | Solo aparece cuando el ámbito está establecido en `Store View`. Elija la [vista de tienda](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html) a los que se sincronizan los valores de atributo de Amazon. Elección `All Store Views (Global)` actualiza el valor en todas las [!DNL Commerce] vistas de la tienda. |
...
| [!UICONTROL Magento Product Attribute Scope] | No aparece al editar un atributo si el atributo se creó con `Global` ámbito. Indica que la variable [!DNL Commerce] [ámbito](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html#scope-settings) se creó y se estableció en `Store View`. |
| [!UICONTROL Store Views (to import values into to)] | Elija su [!DNL Commerce] [vista de tienda](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html) a la que se sincronizan los valores de atributo de Amazon. Elección `All Store Views (Global)` actualiza el valor en todas las vistas de tiendas. |
