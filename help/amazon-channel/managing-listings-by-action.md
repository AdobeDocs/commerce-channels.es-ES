...
| [[!UICONTROL Create New Catalog Product(s)]](./creating-assigning-catalog-products.md) | Cree un [!DNL Commerce] catalogar el producto utilizando la información importada con la lista de Amazon. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
| Intentar coincidencia automática | Intente que haya una coincidencia automática entre sus [!DNL Commerce] catálogo y anuncios de Amazon basados en la configuración de criterios de búsqueda. Para intentar volver a coincidir, debe modificar su [Listing](./listing-settings.md) y [Buscar en el catálogo](./catalog-search.md) para aumentar el potencial de coincidencia automática. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
| [[!UICONTROL Assign Catalog Product]](./creating-assigning-catalog-products.md) | Seleccione manualmente un producto existente en su [!DNL Commerce] y asígnelo a la lista de Amazon. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
| [[!UICONTROL Create New Catalog Product]](./creating-assigning-catalog-products.md) | Cree un [!DNL Commerce] catalogar el producto utilizando la información importada con la lista de Amazon. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
| [[!UICONTROL Publish Product to Amazon]](./publish-listings-manually.md) | (Acción masiva) Se utiliza para volver a enumerar una lista que ha finalizado o para enumerar manualmente un producto que cumpla los requisitos de las reglas de la lista, pero su _[!UICONTROL Product Listing Actions]_no está configurado como `Automatically list new products`. | [[!UICONTROL Ready to List]](./ready-to-list.md)<br>[[!UICONTROL Ended]](./ended-listings.md) |
| [[!UICONTROL Publish On Amazon]](./publish-listings-manually.md) | (Acción de lista única) Se utiliza para volver a enumerar una lista que ha finalizado. Esta acción también se usa para listar manualmente un producto que cumpla las reglas de listado cuando _[!UICONTROL Product Listing Actions]_no está configurado como `Automatically list new products`. | [[!UICONTROL Ready to List]](./ready-to-list.md)<br>[[!UICONTROL Ended]](./ended-listings.md) |
...
1. En el panel de la tienda, haga clic en **Administrar anuncios** en el _Almacenar anuncios_ para obtener más información.
